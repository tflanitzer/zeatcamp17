...
export class LuisClientService {
  readonly introductionApiEndpoint = 'https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/a74a06b1-0340-4c8e-8e35-38bd629d627a?subscription-key=b3d00b46afdb437f861f3690e1752d72&verbose=true&q=';
  ...
  analyzeIntroduction(introductionText: string): Observable<IntroducedPerson> {
    ...
    return this.http.get(requestUrl)
      ...
      .map(json => {
        ...
        let ageEntity = entities.find(entity => entity.type == 'age');
